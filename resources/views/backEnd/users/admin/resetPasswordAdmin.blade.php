...
<div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><span> <a href="{{ route('showAdmins') }}" data-toggle="tooltip" title="Back" class="btn btn-info" data-placement="bottom"> <i class="fa fa-chevron-left"></i></a></span>Reset password</h3>
      </div>
    </div>
...
<div class="col-md-12 col-sm-12">
        ...
        @endif
        <div class="x_content">
            <form class="" action="{{ route('updateNewPasswordAdmin', $admin->id) }}" method="post" novalidate>
                @csrf
