...
<div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><span> <a href="{{ route('showCustomers') }}" data-toggle="tooltip" title="Back" class="btn btn-info" data-placement="bottom"> <i class="fa fa-chevron-left"></i></a></span>Create customer</h3>
      </div>
    </div>
...
<div class="col-md-12 col-sm-12">
        ...
        @endif
        <div class="x_content">
            <form class="" action="{{ route('insertCustomer') }}" method="post" novalidate>
                @csrf
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" class="form-control" name="role" id="role" value="customer" placeholder="Customer" readonly/>
