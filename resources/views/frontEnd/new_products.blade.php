        ...
        <div class="container">
            <div class="box">
                <div class="breadcumb">
                    ...
                    <a href="#" class="{{request()-> routeIs('showNewProducts')? 'active' : '' }}">New products</a>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-12">
						...
						<div class="store-filter clearfix">
                            ...
                            <div class="float-end text-muted">
                                Total Results: {{ $new_products->total() }}
                            </div>
                        ...
                        {{ $new_products->appends($_GET)->links('vendor.pagination.custom') }}
                    </div>
                </div>
            </div>
        </div>
